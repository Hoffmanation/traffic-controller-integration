...
public interface CommandApi {
    ...
    ResponseEntity<CommandResultDto> sendCommand(
    ...
    ResponseEntity<List<CommandResultDto>> getCommandHistory(@Parameter(description = "ID of the controller", example = "fd35.z1.suburb12.loc")
                                                             @PathVariable String controllerId,
